<?php if (!defined('THINK_PATH')) exit(); if(is_array($style)): foreach($style as $key=>$v): ?><tr>
                                        <td>
                                            <?php echo ($a++); ?>
                                        </td>
                                         <td >
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/Style/style_edit/id/'.$v['id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a> 
