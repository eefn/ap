            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>装修预算信息</h5>
                        <small><a href="<?php echo U('Admin/House/house_budget_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>装修预算列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/House/house_budget_edit');?>" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($house_budget["id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">预算</label>

                                <div class="col-sm-3">
                                    <input type="text" name="name" value="<?php echo ($house_budget["name"]); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="ord" value="<?php echo ($house_budget["ord"]); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>装修预算名：</label>
                                    <input type="email" placeholder="请输入装修预算名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码：</label>
