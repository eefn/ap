            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/Designer/designer_add');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <select class="form-control" name="lv_id">
                                        <?php if(is_array($designer_lv)): foreach($designer_lv as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                   </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <label>
                                    <input type="radio" checked="" value="1" id="optionsRadios1" name="is_king">是</label>
                                 <label>
                                <input type="radio" value="0" id="optionsRadios2" name="is_king">否</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" name="jointime" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
