...
<body class="gray-bg">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Service/service_add');?>" class="btn btn-primary btn-xs">添加服务</a>
                        </div>
                    </div>
    ...
    <script src="/ap/Public/Admin/js/plugins/sweetalert/sweetalert.min.js"></script>
     <script>
      $.ajax({
        type:'get',
        url:"<?php echo U('Admin/Service/ajaxService');?>",
        dataType:'html',
        success:function(z){
          $('.table tbody').html(z);
        }
            ...
            var tr=$(this).parent('td').parent('tr');
              swal({
                  ...
                  if (isConfirm) {
                      $.ajax({
                        type:'post',
                        url:"<?php echo U('Admin/Service/service_del');?>",
                        data:"del_id="+del_id,
                        dataType:'text',
                        success:function(z){
                          if(z){
