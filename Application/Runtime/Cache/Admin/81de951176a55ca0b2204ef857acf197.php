            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>轮播图信息</h5>
                        <small><a href="<?php echo U('Admin/News/news_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>轮播图列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/News/news_edit');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img src="/ap/Public/<?php echo ($news["image"]); ?>" alt="" id="img">
                                    <p>图片大小为1900*560</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" name="addtime" value="<?php echo (date('Y-m-d',$news["addtime"])); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="ord" value="<?php echo ($news["ord"]); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <select class="form-control" name="cat_id">
                                    <?php if(is_array($news_cat)): foreach($news_cat as $key=>$value): ?><option value="<?php echo ($value["id"]); ?>" <?php if(($value["id"]) == $news["cat_id"]): ?>selected<?php else: ?>''<?php endif; ?>><?php echo ($value["name"]); ?></option><?php endforeach; endif; ?>
                                   </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <script id="editor" type="text/plain" name="content" style="width:800px;height:400px;"><?php echo (html_entity_decode($news["content"])); ?></script>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>轮播图名：</label>
                                    <input type="email" placeholder="请输入轮播图名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码：</label>
