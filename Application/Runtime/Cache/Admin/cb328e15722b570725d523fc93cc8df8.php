...
<body class="gray-bg">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Designer/designer_add');?>" class="btn btn-primary btn-xs">添加设计师</a>
                        </div>
                    </div>
    ...
    <script>
      $.ajax({
        type:'get',
        url:"<?php echo U('Admin/Designer/ajaxDesigner');?>",
        dataType:'html',
        success:function(z){
          $('.table tbody').html(z);
        }
            ...
            var tr=$(this).parent('td').parent('tr');
              swal({
                  ...
                  if (isConfirm) {
                      $.ajax({
                        type:'post',
                        url:"<?php echo U('Admin/Designer/designer_del');?>",
                        data:"del_id="+del_id,
                        dataType:'text',
                        success:function(z){
                          if(z){
