            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>装修风格信息</h5>
                        <small><a href="<?php echo U('Admin/House/house_style_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>装修风格列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/House/house_style_edit');?>" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($house_style["id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">风格</label>

                                <div class="col-sm-3">
                                    <input type="text" name="style_name" value="<?php echo ($house_style["style_name"]); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" name="addtime" value="<?php echo (date('Y-m-d',$house_style["addtime"])); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="ord" value="<?php echo ($house_style["ord"]); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>装修风格名：</label>
                                    <input type="email" placeholder="请输入装修风格名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码：</label>
