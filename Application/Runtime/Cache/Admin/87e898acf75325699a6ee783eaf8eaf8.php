        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins">apache 2.2.21</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins">mysql 5.5.20</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                                        ...
                                        <table class="table table-hover margin bottom">
                                            ...
                                            <tbody>
                                                <?php if(is_array($admin)): foreach($admin as $key=>$v): ?><tr>
                                                        ...
                                                        <td class="text-center small"><i class="fa fa-clock-o"></i> <?php echo (date('Y.m.d',$v["lasttime"])); ?></td>
                                                        <td class="text-center"><img src="/Public/<?php echo ($v["image"]); ?>" class="img-circle" alt="">
                                                        </td>
