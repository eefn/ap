...
<body class="gray-bg">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Liucheng/liucheng_add');?>" class="btn btn-primary btn-xs">添加流程</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            <table class="table table-hover" style="text-align:center">
                                  ...
                                  <tbody>
                                      <?php if(is_array($liucheng)): foreach($liucheng as $key=>$v): ?><tr>
                                          <td>
                                              <?php echo ++$offset;?>
                                          </td>
                                          <td>
                                          ...
                                          <td>
                                              <a href="<?php echo U('Admin/Liucheng/liucheng_edit/id/'.$v['id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>                                        
    ...
    <script src="/ap/Public/Admin/js/plugins/sweetalert/sweetalert.min.js"></script>s
    <script>
          $(".del").click(function() {
            ...
            var tr=$(this).parent('td').parent('tr');
              swal({
                  ...
                  if (isConfirm) {
                      $.ajax({
                        type:'post',
                        url:"<?php echo U('Admin/Liucheng/liucheng_del');?>",
                        data:"del_id="+del_id,
                        dataType:'text',
                        success:function(z){
                          if(z){
