            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>轮播图信息</h5>
                        <small><a href="<?php echo U('Admin/Banner/banner_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>轮播图列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/Banner/banner_edit');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img src="/ap/Public/<?php echo ($banner["image"]); ?>" alt="" id="img">
                                    <p>图片大小为1900*560</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" name="addtime" value="<?php echo (date('Y-m-d',$banner["addtime"])); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="ord" value="<?php echo ($banner["ord"]); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
