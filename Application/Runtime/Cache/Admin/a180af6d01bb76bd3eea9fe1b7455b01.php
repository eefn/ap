...
<head>
    ...
    <title>导航管理</title>
    <meta name="keywords" content="H+后台主题,后台bootstrap框架,导航中心主题,后台HTML,响应式后台">
    <meta name="description" content="H+是一个完全响应式，基于Bootstrap3最新版本开发的扁平化主题，她采用了主流的左右两栏式布局，使用了Html5+CSS3等现代技术">

    <link rel="shortcut icon" href="/Public/Admin/favicon.ico"> <link href="/Public/Admin/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
...
<body class="gray-bg">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/nav/nav_add');?>" class="btn btn-primary btn-xs">添加导航</a>
                        </div>
                        <div class="ibox-tools ccc">
                            <a href="" aaa="0" class="btn btn-primary btn-xs">显示全部</a>
                        </div>
                    </div>
    ...
    $(document).on('click','.del',function(){ 
       ...
       $.ajax({
        type:'get',
        url:"<?php echo U('Admin/Nav/ajaxPro');?>",
        dataType:'html',
        success:function(z){
          $('.table tbody').html(z);
        }
       ...
       $(document).on('click','.page a',function(){
        ...
        $(document).on('click','.aaaa a',function(){
                  var aaa=$(this).attr('aaa');
                  $.ajax({
                      type:'get',
                      url:"<?php echo U('Admin/Nav/ajaxPro');?>",
