            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>设计师等级信息</h5>
                        <small><a href="<?php echo U('Admin/Designer/designer_lv_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>设计师等级列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/Designer/designer_lv_add');?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>设计师等级名：</label>
                                    <input type="email" placeholder="请输入设计师等级名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码：</label>
