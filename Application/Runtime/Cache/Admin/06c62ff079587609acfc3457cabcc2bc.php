...
<head>
    ...
    <title>风格管理</title>
    <meta name="keywords" content="H+后台主题,后台bootstrap框架,风格中心主题,后台HTML,响应式后台">
...
<body class="gray-bg">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Style/style_add');?>" class="btn btn-primary btn-xs">添加风格</a>
                        </div>
                    </div>
    ...
    $(document).on('click','.del',function(){ 
            ...
            var tr=$(this).parent('td').parent('tr');
              swal({
                  ...
                  if (isConfirm) {
                    $.ajax({
                      type:'post',
                      url:"<?php echo U('Admin/Style/style_del');?>",
                      data:"del_id="+del_id,
                      dataType:'text',
                      success:function(z){ 
                      console.log(z);                  
       ...
       $.ajax({
        type:'get',
        url:"<?php echo U('Admin/Style/ajaxPro');?>",
        dataType:'html',
        success:function(z){
          $('.table tbody').html(z);
        }
