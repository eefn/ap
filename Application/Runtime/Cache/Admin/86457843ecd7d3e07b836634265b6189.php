            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/Designer/designer_style_add');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <select class="form-control" name="style_id">
                                        <?php if(is_array($designer_style)): foreach($designer_style as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["style_name"]); ?></option><?php endforeach; endif; ?>
                                   </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
