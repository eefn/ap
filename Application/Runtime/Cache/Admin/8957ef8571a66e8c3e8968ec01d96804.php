            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>服务信息</h5>
                        <small><a href="<?php echo U('Admin/Service/service_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>服务列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/Service/service_edit');?>" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($service["id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">大标题</label>

                                <div class="col-sm-3">
                                    <input type="text" name="max_title" value="<?php echo ($service["max_title"]); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="min_title" value="<?php echo ($service["min_title"]); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img src="/ap/Public/<?php echo ($service["image"]); ?>" alt="" id="img">
                                    <p>图片大小为67*67</p>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="ord" value="<?php echo ($service["ord"]); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>服务名：</label>
                                    <input type="email" placeholder="请输入服务名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码：</label>
