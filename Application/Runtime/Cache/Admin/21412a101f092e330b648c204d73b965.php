...
<body class="gray-bg">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/House/house_type_add');?>" class="btn btn-primary btn-xs">添加装修户型</a>
                        </div>
                    </div>
    ...
    <script src="/ap/Public/Admin/js/plugins/sweetalert/sweetalert.min.js"></script>
     <script>
        $.ajax({
          type:'get',
          url:"<?php echo U('Admin/House/ajaxHouse_type');?>",
          dataType:'html',
          success:function(z){
            $('.table tbody').html(z);
          }
              ...
              var tr=$(this).parent('td').parent('tr');
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                          type:'post',
                          url:"<?php echo U('Admin/House/house_type_del');?>",
                          data:"del_id="+del_id,
                          dataType:'text',
                          success:function(z){
                            if(z==1){
