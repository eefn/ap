            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>流程信息</h5>
                        <small><a href="<?php echo U('Admin/Liucheng/liucheng_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>流程列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/Liucheng/liucheng_add');?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>流程名：</label>
                                    <input type="email" placeholder="请输入流程名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码：</label>
