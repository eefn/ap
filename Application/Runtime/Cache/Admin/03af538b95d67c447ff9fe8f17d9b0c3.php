            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>设计师风格信息</h5>
                        <small><a href="<?php echo U('Admin/Designer/designer_style_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>设计师风格列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('Admin/Designer/designer_style_edit');?>" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($designer_common["id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">设计师</label>

                                <div class="col-sm-2">
                                   <select class="form-control" name="designer_id">
                                        <?php if(is_array($designer)): foreach($designer as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if(($designer_common['designer_id']) == $v['id']): ?>selected<?php endif; ?>><?php echo ($v["designer_name"]); ?></option><?php endforeach; endif; ?>
                                   </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <select class="form-control" name="style_id">
                                        <?php if(is_array($designer_style)): foreach($designer_style as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if(($designer_common['style_id']) == $v['id']): ?>selected<?php endif; ?>><?php echo ($v["style_name"]); ?></option><?php endforeach; endif; ?>
                                   </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <label>
                                    <input type="radio"  value="1" id="optionsRadios1" name="is_show" <?php if(($designer_common['is_show']) == "1"): ?>checked<?php endif; ?>>是</label>
                                 <label>
                                <input type="radio"  value="0" id="optionsRadios2" name="is_show" <?php if(($designer_common['is_show']) == "0"): ?>checked<?php endif; ?>>否</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>设计师风格名：</label>
                                    <input type="email" placeholder="请输入设计师风格名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码：</label>
