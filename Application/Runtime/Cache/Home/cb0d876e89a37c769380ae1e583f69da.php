...
<link href="/Public/Home/css/insidepublic.css" rel="stylesheet"/>  
...
<div class="vr_banner">
 ...
 &gt; <!-- <a href="<?php echo U('Home/Designer/designer');?>">设计团队</a> &gt;  --><a href="<?php echo U('Home/Designer/designer');?>">设计师</a>                    &gt; <strong><?php echo ($designer["designer_name"]); ?></strong>
                </h3>
...
<div class="container designers_details">
    ...
    <div class="designers_details_data">
        <div class="data_pic">
            <span><img src="/Public/<?php echo ($designer["image"]); ?>" alt="" style="width: 280px;height: 280px;" /></span>
            <ul>
                <li><p><?php echo ($designer["click"]); ?></p>浏览</li>
                <li class="line"><p><?php echo ($count); ?></p>案例</li>
                <li><p><?php echo ($designer["price"]); ?></p>设计费/平米</li>
            </ul>
        </div>
        <div class="data_detail">            
            <h2><?php echo ($designer["name"]); ?><span><?php echo ($designer["l_name"]); ?></span></h2>
            <p><b>入行时间：</b><?php echo (date('Y',$designer["jointime"])); ?>年</p>
            <p><b>擅长：</b><?php echo (html_entity_decode($designer["description"])); ?></p>    
            <div class="data_list">  
                <p><b>爱好：</b><?php echo ($designer["hobby"]); ?> </p>
                <p><b>所属门店：</b><?php echo ($designer["store"]); ?></p>
                <p><b>所属服务社：</b><?php echo ($designer["service_center"]); ?></p>
                <p><b>毕业学校：</b><?php echo ($designer["school"]); ?></p>
    ...
    <div class="cases_baojia">
            <h3><img src="/Public/Home/picture/cases_baojia.jpg" alt="" /></h3>
...
<div class="container designers_cases_top">
    <img src="/Public/Home/picture/designers_cases_top.jpg" alt="" />
</div>
...
<script>
    $.ajax({
            type:'get',
            url:"<?php echo U('Home/Designer/ajaxdesigner_art');?>",
            data:'designer_id=<?php echo ($designer["id"]); ?>',
            dataType:'html',
            success:function(z){
                $('.cases_list').html(z);
            }
