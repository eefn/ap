...
<div class="container top">
 ...
 &gt; <a href="<?php echo U('Home/Anli/anli');?>">精品案例</a> &gt; <strong><?php echo ($house["house_name"]); ?></strong></h3>
...
<div class="container cases_details">
    <div class="cases_details_left">
        ...
        <div class="cases_details_title"><?php echo ($house["house_name"]); ?></div>
        <div class="cases_details_title_detaileds">
            <?php if(is_array($type)): foreach($type as $key=>$value): if(($house["type_id"]) == $value["id"]): ?><label><?php echo ($value["type_name"]); ?></label><?php endif; endforeach; endif; ?>
            <?php if(is_array($style)): foreach($style as $key=>$value): if(($house["style_id"]) == $value["id"]): ?><label><?php echo ($value["style_name"]); ?></label><?php endif; endforeach; endif; ?>
            <label><?php echo ($house["size"]); ?>m&sup2</label>
            <span class="cases_details_loves"><i><?php echo ($house["buy"]); ?></i>喜欢</span>
            <span><i><?php echo ($house["buy"]); ?></i>人气</span>
        </div>
        <div class="cases_details_table">
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td><?php echo ($house["vitrolite_brand"]); ?></td>
                        <td><?php echo ($house["floor_brand"]); ?></td>
                        <td><?php echo ($house["cupboard_brand"]); ?></td>
                        <td><?php echo ($house["door_brand"]); ?></td>
                        <td><?php echo ($house["hardware_brand"]); ?></td>
                        <td><?php echo ($house["clean_brand"]); ?></td>
                        <td><?php echo ($house["top_brand"]); ?></td>

                    </tr>
                    <tr>
                        <td class="bold">总费用</td>
                        <td>
                            <?php echo ($house["all_price"]); ?>万
                        </td>
                        <td class="bold">主材金额</td>
                        <td>
                            <?php echo ($house["main_price"]); ?>万
                        </td>
                        <td class="bold">辅材金额</td>
                        <td>
                            <?php echo ($house["auxiliary_price"]); ?>万
                        </td>
                        <td class="bold">工程费用</td>
                        <td>
                            <?php echo ($house["engineering"]); ?>万
                        </td>
                    </tr>
        ...
        <div class="cases_details_show"><p>
            <?php echo (html_entity_decode($house["content"])); ?>
        </div>
